...
// User.belongsToMany(User, {through: Conversation, as: 'talks_with', foreignKey: 'receiver_key', onDelete: 'SET NULL'});
// User.hasMany(Conversation, { foreignKey: 'userkey', onDelete: 'SET NULL'});
// Conversation.belongsTo(User, { foreignKey: 'receiver_key', onDelete: 'SET NULL' });
...
// User.belongsTo(Conversation, { foreignKey: 'receiver_key', onDelete: 'SET NULL'});
Conversation.belongsTo(User, { foreignKey: 'sender_key', onDelete: 'SET NULL' });
// Conversation.hasOne(User, { foreignKey: 'receiver_key', onDelete: 'SET NULL' });
